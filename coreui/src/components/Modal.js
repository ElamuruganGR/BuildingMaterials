...
export default function Modal(props){
    ...
    const submit = (event) => {
        ...
        Axios.post("http://localhost:8080/todaysCos",todaysCostInput)
             .then(res => {
    ...
    return(
        <div className="modal_overlay">
            <div className="modal_content">
                <div id="modal_heading" className="modal_heading align_center">Today's cost of construction materials</div>
                {error && <div className="error align_center">Please enter a value greater than 0</div>}
                <form id="modal_body" className="grid_container"  onSubmit={validateAndSubmit} >
                    <div className="grid_element split_vertically">
                        <label htmlFor="brickCost" className="label">Brick</label>
                        <label htmlFor="brickCost" className="unit">(per brick)</label>
                    </div>
                    <div  className="grid_element colon">:</div>
                    ...
                    <div className="grid_element split_vartically">
